####################################################################################
### Fit Primary Dirichlet-Multinomial Regression Model with Salamander 16S Reads ###
####################################################################################
...
working_directory<-"/uufs/chpc.utah.edu/common/home/gompert-group2/data/kg_microbes/Scripts/Models/Composition/Salamander/Region16S/Take3"
...
pred_matrix_scaled<-as.data.frame(model.matrix(~Age*LM*Site*poly(Week,degree=2,raw=T)-1,data=pred_matrix_scaled))
