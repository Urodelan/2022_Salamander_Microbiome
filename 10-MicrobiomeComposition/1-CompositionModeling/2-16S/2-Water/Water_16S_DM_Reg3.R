###############################################################################
### Fit Primary Dirichlet-Multinomial Regression Model with Water 16S Reads ###
###############################################################################
...
working_directory<-"/uufs/chpc.utah.edu/common/home/gompert-group2/data/kg_microbes/Scripts/Models/Composition/Water/Region16S/Take3"

# Declare path to reads in-file (with .csv extension).
reads_in_file<-"Water_ASVTable_16S_Comp_2.csv"
