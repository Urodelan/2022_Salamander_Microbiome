##########################################################################################
### Fit Water Quality Dirichlet-Multinomial Regression Model with Salamander ITS Reads ###
##########################################################################################
...
working_directory<-"/uufs/chpc.utah.edu/common/home/gompert-group2/data/kg_microbes/Scripts/Models/Composition/Salamander/RegionITS/WQ"

# Declare path to reads in-file (with .csv extension).
reads_in_file<-"Salamander_ASVTable_ITS_Comp_2.csv"
