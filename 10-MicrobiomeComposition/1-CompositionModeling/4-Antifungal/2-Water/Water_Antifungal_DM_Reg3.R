######################################################################################
### Fit Primary Dirichlet-Multinomial Regression Model with Water Antifungal Reads ###
######################################################################################
...
working_directory<-"/uufs/chpc.utah.edu/common/home/gompert-group2/data/kg_microbes/Scripts/Models/Composition/Water/Antifungal/Take3"

# Declare path to reads in-file (with .csv extension).
reads_in_file<-"Water_Antifungal_Table.csv"
