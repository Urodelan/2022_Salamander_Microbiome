###########################################################################################
### Fit Primary Dirichlet-Multinomial Regression Model with Salamander Antifungal Reads ###
###########################################################################################
...
working_directory<-"/uufs/chpc.utah.edu/common/home/gompert-group2/data/kg_microbes/Scripts/Models/Composition/Salamander/Antifungal/Take3"

# Declare path to reads in-file (with .csv extension).
reads_in_file<-"Salamander_Antifungal_Table.csv"
