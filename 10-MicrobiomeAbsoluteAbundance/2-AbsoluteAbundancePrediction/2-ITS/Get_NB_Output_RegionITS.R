########################################################################################
### Work Up Output from Negative Binomial Regression Model with Salamander ITS Reads ###
########################################################################################
...
working_directory<-"/uufs/chpc.utah.edu/common/home/gompert-group2/data/kg_microbes/Scripts/Models/Output/Absolute/RegionITS"

# Declare path to reads in-file (with .csv extension).
reads_in_file<-"/uufs/chpc.utah.edu/common/home/gompert-group2/data/kg_microbes/Scripts/Models/Absolute/Salamander/RegionITS/Take3/Salamander_ASVTable_ITS_Rate_2.csv"

# Declare path to directory with model outputs.
path_to_model_output<-"/uufs/chpc.utah.edu/common/home/gompert-group2/data/kg_microbes/Scripts/Models/Absolute/Salamander/RegionITS/Take3/Parallel"
