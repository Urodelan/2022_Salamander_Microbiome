########################################################################
### Fit Negative Binomial Regression Model with Salamander ITS Reads ###
########################################################################
...
working_directory<-"/uufs/chpc.utah.edu/common/home/gompert-group2/data/kg_microbes/Scripts/Models/Absolute/Salamander/RegionITS/Take3/Parallel"
